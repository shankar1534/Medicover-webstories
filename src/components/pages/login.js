      ...
      <div class="col-xxl-7 col-md-7">
        <div class="card">
          <div class="card-header text-center">
            <img src={medicovericon} alt="site logo" class="light-logo" />
          </div>
          <div class="card-body">
            <div class="row gy-3">
              <div class="col-12">
